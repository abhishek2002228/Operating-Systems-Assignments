...
Jahnavi Gurdasani 2019AAPS0556H
Dhruv Makwana 2019A30381H
Parth Chauhan 2019A3PS0415H
Shubham Priyank 2019AAPS0467H
...
// find the no of empty cells in the board.
...
void *solve_thread(void *arg){
    ...
    if(check(board,r,c,v,s) == 1){
        board[r][c] = v;
		int ut = tc_glob <= 8 ? 1 : 0; // limit threads to 8 change to 16 on server
